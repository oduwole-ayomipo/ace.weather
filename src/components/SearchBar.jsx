...
function SearchBar() {
  return (
    <div className='search-navbar flex items-center justify-between font-Comfortaa font-medium text-custom-secondary text-xs bg-custom-white w-full m-3 max-[284px]:text-[10px]  min-[520px]:px-6 md:justify-end'>
