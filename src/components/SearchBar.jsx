...
function SearchBar() {
  return (
    <div className='search-navbar flex items-center justify-between font-Comfortaa font-medium   text-xs w-full p-3 max-[284px]:text-[10px]  min-[520px]:px-6 md:justify-end'>
